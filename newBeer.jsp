...
<body>
	...
	try {
		...
		String url = "jdbc:mysql://mydb.cergxdgntjcl.us-east-2.rds.amazonaws.com:3306/pubbeerdrinker";	
		...
		//Populate SQL statement with an actual query. It returns a single number. The number of beers in the DB.
		str = "SELECT COUNT(*) as cnt FROM pubs";
		//Run the query against the DB
		...
		String newBar = request.getParameter("pubs");
		String newBeer = request.getParameter("beer");
		float price = Float.valueOf(request.getParameter("price"));


		//Make an insert statement for the Sells table:
		String insert = "INSERT INTO serves(pub, beer, cost)"
				+ "VALUES (?, ?, ?)";
